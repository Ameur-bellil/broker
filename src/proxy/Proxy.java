...
public class Proxy {
    ...
    public Proxy(int proxyPort, String serverAddress, int serverPort) {
    ...
    public void startProxy() {
        ...
        try (ServerSocket proxySocket = new ServerSocket(proxyPort)) {
            ...
            while (true) {
                ...
                executor.submit(new TrafficRelayer(clientSocket, serverSocket));
                executor.submit(new TrafficRelayer(serverSocket, clientSocket));
            }
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        ...
        Proxy proxy = new Proxy(proxyPort, serverAddress, serverPort);
        proxy.startProxy();
    }
}
